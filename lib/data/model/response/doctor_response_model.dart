...
class DoctorResponseModel {
    ...
    factory DoctorResponseModel.fromJson(String str) => DoctorResponseModel.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory DoctorResponseModel.fromMap(Map<String, dynamic> json) => DoctorResponseModel(
        status: json["status"],
        data: json["data"] == null ? [] : List<Doctor>.from(json["data"]!.map((x) => Doctor.fromMap(x))),
    );
